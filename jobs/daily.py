...
from services.database_service import (
	add_or_update_row_koreader_book,
	add_or_update_row_koreader_page_stat,
)
from services.microsoft_service import (
	get_koreader_settings,
	upload_transcribed_article_to_onedrive,
)
...
def monica_before_tasks(
	days_in_future: Annotated[int, Path(title="The ID of the item to get")],
):
